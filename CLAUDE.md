...
- 版本號在 `index.html` 的 `const VERSION`（頁尾顯示「精準務農 vX.Y.Z」，淺灰置中）。
  ...
  目前版本 **v1.8.0**（我的品項「無綜合卡」：勾母作物＝看它全部品種(各品種一張卡、品種名放第二行 mc-var)，
  品種在母作物勾選時鎖住；要單看某品種先取消母作物再勾該品種。看板 boardDisplay 把母作物項展開成各品種卡、
  去重、不再有綜合卡與展開下拉。前一版 v1.7.0：細部品種可各別勾選＋颱風遠了不再追蹤）。
